...
```bash
colcon build --packages-select iros_mobile_platform_database iros_mobile_platform_database_msgs
```
...
1.  **Run the container using Docker Compose:**
    From the `iros_mobile_platform_database` package directory, run:
    ```bash
    docker-compose up -d
    ```
...
```bash
ros2 launch iros_mobile_platform_database database.launch.py
```
...
```bash
ros2 service call /iros_mobile_platform_database_node/store_map iros_mobile_platform_database_msgs/srv/StoreMap '{name: "my_office_map", yaml_path: "/path/to/your/workspace/src/iros_mobile_platform/maps/map.yaml"}'
```
...
```bash
ros2 service call /iros_mobile_platform_database_node/load_map iros_mobile_platform_database_msgs/srv/LoadMap '{name: "my_office_map"}'
```

## Services

### Map Services
- `~/store_map` (`iros_mobile_platform_database_msgs/srv/StoreMap`)
  - Request: `string name`, `string map_yaml_path`
  - Response: `bool success`, `string message`
- `~/get_map` (`iros_mobile_platform_database_msgs/srv/GetMap`)
  - Request: `string name`
  - Response: `string yaml_data`, `nav_msgs/OccupancyGrid map`, `bool success`, `string message`
- `~/load_map` (`iros_mobile_platform_database_msgs/srv/LoadMap`)
  - Request: `string name`
  - Response: `bool success`, `string message`
- `~/delete_map` (`iros_mobile_platform_database_msgs/srv/DeleteMap`)
  - Request: `string name`
  - Response: `bool success`, `string message`
- `~/get_maps` (`iros_mobile_platform_database_msgs/srv/GetMaps`)
  - Request: (empty)
  - Response: `string[] map_names`

### Point Services
- `~/add_point` (`iros_mobile_platform_database_msgs/srv/AddPoint`)
  - Request: `iros_mobile_platform_database_msgs/msg/Point point`
  - Response: `bool success`, `string message`
- `~/list_points` (`iros_mobile_platform_database_msgs/srv/ListPoints`)
  - Request: `string map_name`
  - Response: `iros_mobile_platform_database_msgs/msg/Point[] points`
- `~/delete_point` (`iros_mobile_platform_database_msgs/srv/DeletePoint`)
  - Request: `string map_name`, `string point_name`
  - Response: `bool success`, `string message`

### Route Services
- `~/add_route` (`iros_mobile_platform_database_msgs/srv/AddRoute`)
  - Request: `iros_mobile_platform_database_msgs/msg/Route route`
  - Response: `bool success`, `string message`
- `~/list_points_in_route` (`iros_mobile_platform_database_msgs/srv/ListPointsInRoute`)
  - Request: `string map_name`, `string route_name`
  - Response: `string[] point_names`
- `~/delete_point_in_route` (`iros_mobile_platform_database_msgs/srv/DeletePointInRoute`)
  - Request: `string map_name`, `string route_name`, `string point_name`
  - Response: `bool success`, `string message`
- `~/delete_route` (`iros_mobile_platform_database_msgs/srv/DeleteRoute`)
  - Request: `string map_name`, `string route_name`
  - Response: `bool success`, `string message`
