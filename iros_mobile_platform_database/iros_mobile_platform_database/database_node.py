...
from iros_mobile_platform_database_msgs.srv import StoreMap, GetMap, LoadMap, DeleteMap, GetMapList
from iros_mobile_platform_database_msgs.srv import AddPoint, ListPoints, DeletePoint
from iros_mobile_platform_database_msgs.srv import AddRoute, ListPointsInRoute, DeletePointInRoute, DeleteRoute
from iros_mobile_platform_database_msgs.msg import Point as PointMsg
from iros_mobile_platform_database_msgs.msg import Route as RouteMsg
...
class DatabaseNode(Node):
    def __init__(self):
        super().__init__("iros_mobile_platform_database_node")
