...
def generate_launch_description():
    # RViz node
    rviz_config_file = PathJoinSubstitution([FindPackageShare("iros_mobile_platform"), "rviz", "sim_with_laser_merge.rviz"])
    rviz_node = Node(
        package="rviz2",
        executable="rviz2",
        name="rviz2",
    ...
    localization = IncludeLaunchDescription(
        os.path.join(
            get_package_share_directory("iros_mobile_platform_localization"),
            "launch",
