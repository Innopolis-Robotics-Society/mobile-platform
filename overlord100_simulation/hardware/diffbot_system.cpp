...
#include "odom_pub_diff_control/diffbot_system.hpp"
...
namespace odom_pub_diff_control
{
...
hardware_interface::return_type odom_pub_diff_control ::DiffBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
...
PLUGINLIB_EXPORT_CLASS(
  odom_pub_diff_control::DiffBotSystemHardware, hardware_interface::SystemInterface)
